  ...
  return (
    <a className="block" href="/resume.pdf" target="_blank">
      <svg
        ...
        height="16"
        fill="currentColor"
        className="bi bi-file-earmark-person-fill block w-6 h-6 sm:w-8 sm:h-8 fill-gray-400 hover:fill-white hover:scale-110 transition duration-300 ease-in-out"
        viewBox="0 0 16 16"
      >
