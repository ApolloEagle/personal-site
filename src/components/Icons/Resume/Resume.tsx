  ...
  return (
    ...
    >
      <svg
        ...
        height="16"
        fill="currentColor"
        className="bi bi-file-earmark-person-fill block sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 fill-gray-200 hover:fill-white hover:scale-110 transition duration-300 ease-in-out"
        viewBox="0 0 16 16"
      >
